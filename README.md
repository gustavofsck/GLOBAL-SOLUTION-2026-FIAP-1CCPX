# GLOBAL-SOLUTION-2026-FIAP-1CCPX
Desafio FIAP Indústria Espacial: Ciência da Computação
...
Desenvolver um sistema embarcado para monitoramento em tempo real das condições internas de uma cápsula espacial (simulada) com os seguintes objetivos específicos:
  ...
  * Medir e exibir continuamente temperatura, luminosidade e vibração em um display local LCD 
